...
public class CategoryController {
    ...
    public ResponseEntity updateCategory(@PathVariable@Valid String id , @RequestBody @Valid Category category) {
    ...
    public ResponseEntity deleteCategory(@PathVariable@Valid String id) {
