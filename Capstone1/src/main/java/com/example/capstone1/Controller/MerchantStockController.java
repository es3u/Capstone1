...
public class MerchantStockController {
    ...
    public ResponseEntity updateMerchantStock(@PathVariable@Valid String id, @RequestBody@Valid MerchantStock merchantStock) {
    ...
    public ResponseEntity deleteMerchantStock(@PathVariable@Valid String id) {
